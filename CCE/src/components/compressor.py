...
def compressor(t1, p1, m, eta, pr):
    ...
    cp, h1, s, M = thermo_outdated.properties(t1, p1, equ=0)  # enthalpy before compression
    cp, h2, s, M = thermo_outdated.properties(t2, p2, equ=0)  # enthalpy after compression
