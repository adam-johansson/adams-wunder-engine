...
def match_tet_power_v2(data, meta_model, power_req, core_flow, T35_req):
    ...
    def find_match(x):
        ...
        #p_ratio = x[0]  # bore is varied to match power
        far34 = x[0]  # far is varied to match target output temperature

        if far34 < 0.002923 or far34 > 0.02923 or cr > 20:
