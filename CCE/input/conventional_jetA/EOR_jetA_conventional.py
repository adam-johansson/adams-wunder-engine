...
Fs_req = 170.3  # specific thrust [m/s]

# power offtake from HPT
power_offtake = 110*1e3

bpr = 14.3  # bypass ratio

fpr_outer = 1.369  # Outer fan pressure ratio 1.3087

OPR = 42.9  # overall pressure ratio (including losses)
PR = 0.2767  # pressure split, with regard to the LPC

T4 = 1829  # [K] Turbine entry temperature
...
eta_fan = 94.4 / 100  # inner fan polytropic efficiency
