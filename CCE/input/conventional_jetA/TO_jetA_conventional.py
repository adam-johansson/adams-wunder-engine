...
Fs_req = 225.6  # specific thrust [m/s]

# power offtake from HPT
power_offtake = 110*1e3

bpr = 14.4  # bypass ratio

fpr_outer = 1.334  # Outer fan pressure ratio 1.3087

OPR = 38.8  # overall pressure ratio (including losses)
PR = 0.2767  # pressure split, with regard to the LPC

T4 = 1754  # [K] Turbine entry temperature
...
eta_fan = 92.9 / 100  # inner fan polytropic efficiency
