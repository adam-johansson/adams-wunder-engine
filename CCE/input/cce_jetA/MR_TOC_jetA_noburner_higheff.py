...
# piston engine stuff
pi_pe = 1.59902982796348
cr = 9.37859019392735
far_piston = 3.64965861786858 / 100  * (44 / 43)  # adjust for difference in LHV between JETA and SAF
v_mean = 14
start_of_combustion = 355

OPR = 20.2150846565206 # overall pressure ratio (including losses) (16 + far 03)
PR = 0.257573684787923  # pressure split, with regard to the LPC
eff_IC = 0.7
ratio_IC = 0.998889561535656
