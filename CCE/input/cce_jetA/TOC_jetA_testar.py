...
bpr = 15.53706947 # bypass ratio


fpr_outer = 1.415  # Outer fan pressure ratio

OPR = 18.28420968  # overall pressure ratio (including losses)
PR = 0.119170711  # pressure split, with regard to the LPC
