...
Fn = 24011.5  # [N] #Net thrust requirement 5398 lbf

Fs_req = 76.7  # specific thrust [m/s]
...
fpr_outer = 1.328  # Outer fan pressure ratio
bore = 0.18 # not used
...
eta_fan = 94.8 / 100  # fan (isentropic??? efficiency)
eta_p_lpc = 90.0 / 100  # polytropic
