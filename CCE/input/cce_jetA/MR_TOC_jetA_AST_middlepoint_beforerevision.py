...
pi_pe = 1.58
cr = 11.32  # 8
far_piston = 0.0278  * (44 / 43)  # adjust for difference in LHV between JETA and SAF
v_mean = 14
start_of_combustion = 355

OPR = 17.11  # overall pressure ratio (including losses) (16 + far 03)
PR = 0.367  # pressure split, with regard to the LPC
eff_IC = 0.7
ratio_IC = 0.994
EGR_rate = 0.0

T4 = 1210  # [K] Turbine entry temperature (1200)
