...
pi_pe = 1.58
cr = 10.48  # 8
far_piston = 0.0390  * (44 / 43)  # adjust for difference in LHV between JETA and SAF
v_mean = 14
start_of_combustion = 355

OPR = 17.53  # overall pressure ratio (including losses) (16 + far 03)
PR = 0.243  # pressure split, with regard to the LPC
eff_IC = 0.7
ratio_IC = 0.987
EGR_rate = 0.0

T4 = 1035  # [K] Turbine entry temperature (1200)
