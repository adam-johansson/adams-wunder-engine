...
Fn = 49.73e3  # [N] #Net thrust requirement

bpr = 33.7  # Bypass ratio

opr = 38.0  # Overall pressure ratio
pi_ipc = 3.4  # IPC Pressure ratio
pi_hpc = 5.6  # HPC pressure ratio
pi_pe = 1.80  # Piston engine pressure ratio
fpr = opr/(pi_pe*pi_hpc*pi_ipc)  # Fan pressure ratio

TET = 1700  # [K] Turbine entry temperature

eta_intake = 99.7/100  # intake efficiecy
eta_p_fan = 90/100  # fan polytropic efficency
