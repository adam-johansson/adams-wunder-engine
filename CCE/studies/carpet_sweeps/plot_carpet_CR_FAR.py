...
data = np.loadtxt("./results/CR_FAR/thermal_eff.dat")

OPR = data[1:,0]
T4 = data[0,1:]

eff = data[1:,1:]
nox = np.loadtxt("./results/CR_FAR/specific_nox.dat")[1:,1:]
power = np.loadtxt("./results/CR_FAR/core_spec_power.dat")[1:,1:]
pmax = np.loadtxt("./results/CR_FAR/peak_pressure.dat")[1:,1:]
bore = np.loadtxt("./results/CR_FAR/bore.dat")[1:,1:]
Tout = np.loadtxt("./results/CR_FAR/Tout_piston.dat")[1:,1:]
...
fig.write_image("CR_FAR_plot.pdf", width=550, height=850, scale=2)
fig.show()