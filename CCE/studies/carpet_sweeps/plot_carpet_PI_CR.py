...
data = np.loadtxt("./results/PI_CR/thermal_eff.dat")

OPR = data[1:,0]
T4 = data[0,2:]

eff = data[1:,2:]
nox = np.loadtxt("./results/PI_CR/specific_nox.dat")[1:,2:]
power = np.loadtxt("./results/PI_CR/core_spec_power.dat")[1:,2:]
pmax = np.loadtxt("./results/PI_CR/peak_pressure.dat")[1:,2:]
bore = np.loadtxt("./results/PI_CR/bore.dat")[1:,2:]
Tout = np.loadtxt("./results/PI_CR/Tout_piston.dat")[1:,2:]
...
fig.write_image("PI_CR_plot.pdf", width=550, height=850, scale=2)
fig.show()