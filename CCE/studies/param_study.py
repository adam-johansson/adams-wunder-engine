...
ax1.plot(OPRs, SFCs*1e6)


_, ax2 = plt.subplots()

ax2.plot(OPRs, transmission_effs*100,label="Transmission", linewidth="2")
ax2.plot(OPRs, propulsive_effs*100,label="Propulsive", linewidth="2")
ax2.plot(OPRs, core_effs*100,label="Core", linewidth="2")
ax2.plot(OPRs, thermal_effs*100,label="Thermal", linewidth="2")
ax2.plot(OPRs, overall_effs*100,label="Overall", linewidth="2")
ax2.legend()

_, ax3 = plt.subplots()
ax3.plot(OPRs, specific_thrusts)

_, ax4 = plt.subplots()
ax4.plot(OPRs, core_effs*100,label="Core", linewidth="2")
ax4.plot(OPRs, thermal_effs*100,label="Thermal", linewidth="2")
ax4.legend()

_, ax5 = plt.subplots()
ax5.plot(OPRs, transmission_effs*100,label="Transmission", linewidth="2")
ax5.plot(OPRs, propulsive_effs*100,label="Propulsive", linewidth="2")
ax5.legend()

_, ax6 = plt.subplots()
ax6.plot(OPRs, hot_bypass_thrusts*1e-3,label="Hot", linewidth="2")
ax6.plot(OPRs, cold_bypass_thrusts*1e-3,label="Cold", linewidth="2")
ax6.plot(OPRs, core_thrusts*1e-3,label="Core", linewidth="2")
ax6.legend()

_, ax7 = plt.subplots()
ax7.plot(OPRs, piston_fuelflow,label="Piston", linewidth="2")
ax7.plot(OPRs, burner_fuelflow,label="Burner", linewidth="2")
ax7.plot(OPRs, burner_fuelflow + piston_fuelflow,label="Total", linewidth="2")
ax7.legend()

_, ax8 = plt.subplots()
ax8.plot(OPRs, 100*piston_fuelflow / (piston_fuelflow + burner_fuelflow),label="Piston", linewidth="2")
ax8.plot(OPRs, 100*burner_fuelflow/ (piston_fuelflow + burner_fuelflow),label="Burner", linewidth="2")
ax8.legend()
