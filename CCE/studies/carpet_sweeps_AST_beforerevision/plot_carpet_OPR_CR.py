...
fig.add_trace(go.Scatter(
    x=[54],   # adjust to where you want it
    y=[1.21],
    mode="markers",
    marker=dict(
        symbol="x",
...
fig.add_annotation(
    ...
    text="✕  T35 > T4",
    showarrow=False,
    font=dict(size=28, family="Times New Roman", color="black", weight=400),
    bgcolor="white",
    bordercolor="black",
    borderwidth=1,
    borderpad=6,
...
fig.write_image("OPR_CR_plot.pdf", width=550, height=850, scale=2)
fig.show()