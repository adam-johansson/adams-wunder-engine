...
# seed 4,5,6 for fuel burn with secondary burner
# seed 7, 8, 9 for no secondary burner
seed = 4  # change to 2, 3 for other runs
...
def evaluate_cce(x):
    ...
    cce_input["PR"] = split
    cce_input["cr"] = cr
    cce_input["far piston"] = (far / 100) * (44/43) # to account for that LHV inside the simulation is 43 MJ
