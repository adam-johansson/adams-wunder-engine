...
data = np.loadtxt("./results/SC_CD/thermal_eff.dat")

OPR = data[1:,0]
T4 = data[0,1:]

eff = data[1:,1:]
nox = np.loadtxt("./results/SC_CD/specific_nox.dat")[1:,1:]
power = np.loadtxt("./results/SC_CD/core_spec_power.dat")[1:,1:]
pmax = np.loadtxt("./results/SC_CD/peak_pressure.dat")[1:,1:]
bore = np.loadtxt("./results/SC_CD/bore.dat")[1:,1:]
Tout = np.loadtxt("./results/SC_CD/Tout_piston.dat")[1:,1:]
...
fig.write_image("SC_CD_plot.pdf", width=550, height=850, scale=2)
fig.show()