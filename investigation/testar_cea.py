...
burning = cea.HPProblem(
    pressure=10, pressure_units="bar", materials=[air2, jetA], massf=True, phi=phicea
)
exhaust = burning.run()
print(exhaust)

print(
    f"CEA HP problem (burner): cp: {exhaust.cp * 1000}, mw: {exhaust.mw}, gamma: {exhaust.gammas},"
...
print(
    f"My own burner: cp: {cp}, mw: {mw * 1000}, gamma: {gamma},"
