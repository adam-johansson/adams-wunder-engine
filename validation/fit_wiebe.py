...
filename_fuel = os.path.join(dirname, '../piston_engine/validation_output_data/H2_water/heat.txt')
...
dmf = dmfdphi_single_mass_vector(phi_plot, res.x[0], (res.x[1] / 180 * np.pi), (res.x[2] / 180 * np.pi), mf_tot)
