...
from piston_engine.engine import (
    run_piston_engine_numba,
)  # import the piston engine function
...
for T_fuel in variable:
    ...
    (
        ...
        heat_loss,
        p_tdc,
    ) = run_piston_engine_numba(data, flags)
...
if simple:
    ...
    ax6.set_title(rf"Meta model vs simulations")
    # ax2.set_ylim(-10, 10)
