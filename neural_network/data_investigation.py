...
ax1.set_title(rf"Straight. Layers: {layers}, Neurons 1st hidden layer: {hidden_dim}")
ax1.set_ylim(0, 1000)
...
ax2.set_title(rf"Straight. Layers: {layers}, Neurons 1st hidden layer: {hidden_dim}")
# ax2.set_ylim(-10, 10)
# ax1.set_xlim(100, epochs)
