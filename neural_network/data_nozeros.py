...
mask = y.p_max > 0
print(
    f"Number of data points that was removed during sampling {np.count_nonzero(mask == 0)}"
)
...
print(
    f"Number of data points with peak pressure under 300 bar {np.count_nonzero(y_cleaned.p_max < 300 * 1e5)}"
)
