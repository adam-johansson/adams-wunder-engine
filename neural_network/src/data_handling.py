...
def load_inference(filename):
    ...
    model_inference = InferenceModel(
        layers, input_dim, hidden_dim, output_dim, weights, x_scaler, y_scaler
    )
...
def load_ANN(filename):
    ...
    # creates a model with the corresponding dimension
    model_inference = InferenceModelStraight(
        layers, input_dim, hidden_dim, output_dim, weights, scaler, x_1, x_2, y_1, y_2
    )
