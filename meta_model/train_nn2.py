...
X = pd.read_csv('../piston_engine/surrogate_data/backup/h2_validated_woschni_18/xt_cleaned.csv', index_col=0)
y = pd.read_csv('../piston_engine/surrogate_data/backup/h2_validated_woschni_18/yt_cleaned.csv', index_col=0)
...
# 100 Epochs: R2 test: 99.71, R2 train: 99.75
# 1000 Epochs: R2 test: 99.89, R2 train: 99.94
# 2000 Epochs: R2 test: 99.89 R2 train: 99.94
#
