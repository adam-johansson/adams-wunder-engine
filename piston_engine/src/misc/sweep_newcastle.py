...
def sweep_equ(d, flags):
    ...
    for equ in equs:
        ...
        data = [d.p_in, d.T_in, d.p_ratio, d.cycle, d.thermo, d.cooling, d.opposed, d.cr, d.d, d.bsr,
                ...
                d.wm, d.m_wiebe, d.phi_sc, phi_cd_adjusted, d.T_fuel, d.p_fuel, d.it, d.wiebe_type, d.valve_type, far_goal,
        ...
        print(f"Peak pressure: {p_max * 1e-5}, peak temp: {T_max}, NO: {no}, imep: {imep*1e-5} bar")
