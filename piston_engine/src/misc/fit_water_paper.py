...
def heat_release(d, flags):
    ...
    equs = np.linspace(0.26, 0.90, 10)
    phi_cds = np.linspace(63 * np.pi / 180 , 20 * np.pi / 180, 10)
    ...
    for equ, phi_cd in zip(equs, phi_cds):
        ...
        data = [d.p_in, d.T_in, d.p_ratio, d.cycle, d.thermo, d.cooling, d.opposed, d.cr, d.d, d.bsr,
                ...
                d.wm, d.m_wiebe, d.phi_sc, phi_cd, d.T_fuel, d.p_fuel, d.it, d.wiebe_type, d.valve_type, far_goal,
