...
def optimisation_valve_timings(d):
    ...
    def black_box_function(ivo, ivc, evo, evc):
        ...
        print(
            ivo * 180 / np.pi, ivc * 180 / np.pi, evo * 180 / np.pi, evc * 180 / np.pi
        )
    ...
    pbounds = {
        "ivo": (710 / 180 * np.pi, 725 / 180 * np.pi),
        "ivc": (910 / 180 * np.pi, 930 / 180 * np.pi),
        "evo": (505 / 180 * np.pi, 525 / 180 * np.pi),
        "evc": (720 / 180 * np.pi, 740 / 180 * np.pi),
    }
...
def optimisation_combustion(d):
    ...
    pbounds = {
        "wa": (6.75, 7.1),
        "wm": (1.2, 1.95),
        "start": (340 / 180 * np.pi, 350 / 180 * np.pi),
        "duration": (25 / 180 * np.pi, 50 / 180 * np.pi),
    }
    # Create a BayesianOptimization optimizer,
    # and optimize the given black_box_function.
    optimizer = BayesianOptimization(
