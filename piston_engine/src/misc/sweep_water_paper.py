...
def sweep_equ(d, flags):
    ...
    filename_egt = os.path.join(
        dirname, "../../validation_output_data/H2_water/egt.txt"
    )
    filename_volume = os.path.join(
        dirname, "../../validation_output_data/H2_water/volume_eff.txt"
    )
    filename_thermal = os.path.join(
        dirname, "../../validation_output_data/H2_water/thermal_eff.txt"
    )
    filename_power = os.path.join(
        dirname, "../../validation_output_data/H2_water/power.txt"
    )
    ...
    ax6.plot(
        power_val[:, 0], power_val[:, 1], label="Validation", marker="x", color="b"
    )
    ...
    ax5.plot(
        thermal_val[:, 0], thermal_val[:, 1], label="Validation", marker="x", color="b"
    )
    ...
    ax2.plot(
        volume_val[:, 0], volume_val[:, 1], label="Validation", marker="x", color="b"
    )
