...
def twozone_old(phi, P, T, V, m, mf, evo, sc, lhv, far_s, equ, fuel_type, factor, premixed):
    """
    ...
    _, _, _, _, R1, _, _, _ = mixture(
        t_dummy, p_dummy, equivalence_ratio=1 / lambda_0, fuel_type=fuel_type
    )
