...
def CO2(T):
    ...
    # 9365.469 (H(298.15) - H(0))
    h = h + 393510.000 / M  # this is the tabulated value
    # h = h + 393507.75667990296 / M  # this is the actual value of H(298.15)
    return cp, h, s, M
...
def H2O(T):
    ...
    # - 9904.092 (H(298.15) - H(0))
    h = h + 241826.000 / M    #J kg^-1
    # h = h + 241824.62171929397 / M
    return cp, h, s, M
