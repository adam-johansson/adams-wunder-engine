...
def nox_calculations(
    ...
    def dNOdt_fun(t, var):
        return _nox_ode_function(
            t, var, times, temperatures, pressures, volumes, equs, dVdt_s,
            gas, fuel_type
        )
...
def _nox_ode_function(t, var, times, temperatures, pressures, volumes, equs, dVdt_s,
                      gas, fuel_type):
...
def _calculate_gas_concentrations(gas, fuel_type, T, p, equ, c_NO):
