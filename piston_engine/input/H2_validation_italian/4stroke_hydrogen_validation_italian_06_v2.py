...
# THIS IS THE ONE FOR ICAS. 2500 rpm, 06 equivalence ratio
...
# s = 0.074676  # stroke
# rpm = v_mean / (2 * s) * 60
v_mean = 2507 * 2 * 0.085 / 60 # mean velocity 1000 rpm (specified in tysk2)  4.533 = 1000
...
p_in = 1.01325e5 * 1.2  # inlet pressure  (1.27 + 495K in)
T_in = 476.5  # inlet temperature 450 + working angles
...
throttle = 0.02918 * 0.6

phi_sc = (353.5/180)*np.pi  # angle at combustion start 358
phi_cd = (55/180)*np.pi  # angle related to combustion duration  32
