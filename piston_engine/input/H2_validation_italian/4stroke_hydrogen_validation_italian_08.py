...
p_in = 1.01325e5 * 1.3  # inlet pressure  (1.27 + 495K in)
T_in = 510.5  # inlet temperature 450 + working angles
...
phi_sc = (361.0/180)*np.pi  # angle at combustion start 358
phi_cd = (35/180)*np.pi  # angle related to combustion duration  32
