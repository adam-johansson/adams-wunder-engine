...
# THIS IS THE ONE FOR ICAS. 2500 rpm, 04 equivalence ratio
...
# s = 0.074676  # stroke
# rpm = v_mean / (2 * s) * 60
v_mean = 2505 * 2 * 0.085 / 60 # mean velocity 1000 rpm (specified in tysk2)  4.533 = 1000
...
p_in = 1.01325e5 * 1.1  # inlet pressure  (1.27 + 495K in)
T_in = 407.5  # inlet temperature 450 + working angles
p_ratio = 1.01325e5 / p_in  # pressure ratio after and before engine (assumption based on 1% loss in inlet and outlet)
...
throttle = 0.02918 * 0.4

phi_sc = (353.0/180)*np.pi  # angle at combustion start 358
phi_cd = (65/180)*np.pi  # angle related to combustion duration  32
