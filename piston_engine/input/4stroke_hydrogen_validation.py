...
# THESE SETTING MATCHES IMEP perfectly
...
lms = 1 / (2 * 1.2)  # connecting rod ratio (from Kaiser, cite 147 Handbuch Verbrennungsmotor) (1.7 original)
...
open_out = 465  # 464 bäst 5.57 454 4.42 458 5.51 NOT SPECIFIED
diff = 220  # SPECIFIED
