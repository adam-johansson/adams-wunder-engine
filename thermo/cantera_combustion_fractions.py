...
def molar_fractions_combustion(T_soc, p_soc, equ_sc, equ_combustion, fuel_type):
    ...
    if fuel_type == "CH4":
        ...
        ohc_species = [
            species[S]
            for S in ("CO2", "H2O", "O2", "CO", "OH", "H2", "O", "H", "N2", "CH4")
        ]
        ...
        ohc_species = [
            species[S]
            for S in ("co2", "h2o", "o2", "co", "oh", "h2", "o", "h", "n2", "c12h26")
        ]
    ...
    if fuel_type == "CH4":
        gas2.set_equivalence_ratio(
            equ_combustion, "CH4", f"O2:{x_O2}, N2:{x_N2}, CO2:{x_CO2}, H2O:{x_H2O}"
        )
        gas2.equilibrate("HP")
        ...
        gas2.set_equivalence_ratio(
            phi=equ_combustion,
            fuel="h2:1",
            oxidizer=f"O2:{x_O2}, N2:{x_N2}, H2O:{x_H2O}",
            basis="mole",
        )
        # gas2.equilibrate("HP")
        gas2.equilibrate("TP")
