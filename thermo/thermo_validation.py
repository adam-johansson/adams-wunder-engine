...
g_ct = np.zeros([n, n_species])
poly_data = np.zeros([n, n_species, 5])
...
axis[3].set_ylabel("Specific Gibbs free energy [kJ/kg]")
axis[0].legend()
...
axis[1].set_ylabel("Specific enthalpy h [kJ/kg]")
axis[2].set_ylabel("Specific entropy [kJ/(kg K)]")
axis[2].set_ylabel("Specific Gibbs free energy [kJ/kg]")
axis[0].legend()
