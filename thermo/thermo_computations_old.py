...
@njit()
def mixture_old(t, p, equ=0, fuel_type=False, pure_fuel=False, fuel_equ_ratio=0.0):
    """
...
@njit()
def equivalence_derivative_old(equ, t, p, fuel_type, pure_fuel, fuel_equ_ratio):
    """
...
@njit()
def molar_fractions_old(equ, fuel_type, pure_fuel=False, fuel_equ_ratio=0.0):
    """
    Function that return thermodynamic properties of a mixture based on the
    properties of the individual species. This is for a combustion gas of
    JET_A/Diesel (C12H23).
...
@njit()
def mass_fractions_old(equ, fuel_type, pure_fuel, fuel_equ_ratio):
    """
    Function that return thermodynamic properties of a mixture based on the
    properties of the individual species. This is for a combustion gas of
    JET_A/Diesel (C12H23).
