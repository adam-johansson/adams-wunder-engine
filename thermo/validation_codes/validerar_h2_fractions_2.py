...
for equ_sc in equs:
    ...
    xi_N2_dir, xi_CO2, xi_H2O_dir, xi_CO, xi_O2_dir, xi_OH_dir, xi_H2_dir, xi_O_dir, xi_H_dir \
        = cantera_combustion_fractions.molar_fractions_combustion(T, p_soc, equ_sc, equ_combustion, fuel_type)

    fracs_dir[i, :] = np.array([xi_N2_dir, xi_H2O_dir, xi_O2_dir, xi_OH_dir, xi_H2_dir, xi_O_dir, xi_H_dir]) * 100
