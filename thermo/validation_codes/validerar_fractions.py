...
gas.TPX = (
    t_flame,
    p_soc,
    f"CO2:{xi_CO2_0}, H2O:{xi_H2O_0}, O2:{xi_O2_0}, Ar:{xi_Ar_dummy}",
)
...
print(
    f"Molar fractions from OHC system equilibrium after complete combustion (argon) (cantera):"
)
print(
    f"CO2: {xi_CO2}, H2O: {xi_H2O}, CO: {xi_CO}, O2:{xi_O2}, OH:{xi_OH}, H2:{xi_H2}, O:{xi_O}, H{xi_H}"
)
...
print(
    f"Molar fractions from OHC system equilibrium after complete combustion (no argon) (cantera):"
)
print(
    f"N2: {xi_N2}, CO2: {xi_CO2}, H2O: {xi_H2O}, CO: {xi_CO}, O2: {xi_O2}, OH: {xi_OH}, H2: {xi_H2}, O: {xi_O}, H: {xi_H}"
)

xi_N2, xi_CO2, xi_H2O, xi_CO, xi_O2, xi_OH, xi_H2, xi_O, xi_H = (
    molar_fractions_combustion(T_soc, p_soc, equ_soc, equ_combustion, fuel_type)
)
