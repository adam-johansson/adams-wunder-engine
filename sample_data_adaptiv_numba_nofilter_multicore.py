...
def main():
    ...
    input_file = "4stroke_sampling" #4stroke_hydrogen_sampling #4stroke_sampling
    ...
    if fuel == "H2":
        ...
        far_lim = [far_s / 3.3, far_s / 1.1] 
        
    xlimits = np.array([p_lim, T_lim, cr_lim, d_lim, far_lim, p_ratio_lim, v_mean_lim])
    ...
    print(f"Discrepancy: {qmc.discrepancy(sample)} (Low number good.)")
